...
def bbox_iou(
    ...
    if CIoU or DIoU or GIoU or WIoU:
        ...
        if CIoU or DIoU or WIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if WIoU:  # Wise-IoU https://arxiv.org/abs/2301.10051
                # Distance cost with exp normalization
                dist = torch.exp(rho2 / c2.detach())
                return iou, dist  # return iou and focusing weight separately
